  ...
  .controller('primary', function($http){
    ...
    p.getContributors = function(){
      ...
      $http(payload).then(function(result){
        ...
        result.data.forEach(function(contributor){
          console.log(contributor.contributions, p.sumOfContribution)
          p.sumOfContribution = p.sumOfContribution + contributor.contributions
        })
        p.contributors= result.data
        console.log(result)
      }, function(err){
        console.log(err)
      })
